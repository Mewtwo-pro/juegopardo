import { selectPersonaje , selectPlayerCargaImg} from "./test.js"
let escenaSeleccionIniciada = false;
const canvas = document.getElementById("miCanvas");
const ctx = canvas.getContext("2d");
let stadoGame = "startGame" 
// Carga de imágenes
let fondo = new Image(); fondo.src = "/assets/portada/fondo.png";
let tituloa = new Image(); tituloa.src = "/assets/portada/tituloa.png";
let titulob = new Image(); titulob.src = "/assets/portada/titulob.png";
let imgNormal = new Image(); imgNormal.src = "/assets/portada/start.png";
let imgHover = new Image(); imgHover.src = "/assets/portada/start-hover.png";
...
function gameLoop(timestamp) {
    ...
    if (pantallaActual === "inicio") {
        ...
        //finalizamos la ecena de inicio y pasamos a la escena  
        //seleccion de player
        selectPersonaje(); 
    }
    ctx.globalAlpha = 1.0;
...
canvas.addEventListener("mousedown", () => {
    if (pantallaActual === "inicio" && hover) {
        //cargamos las imagenes para la escena seleccionar personajes
        selectPlayerCargaImg();
